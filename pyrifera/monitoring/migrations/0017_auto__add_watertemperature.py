...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WaterTemperature'
        db.create_table('monitoring_watertemperature', (
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
            ('celsius', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=3)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['monitoring.SamplingSite'])),
        ))
        db.send_create_signal('monitoring', ['WaterTemperature'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'WaterTemperature'
        db.delete_table('monitoring_watertemperature')
