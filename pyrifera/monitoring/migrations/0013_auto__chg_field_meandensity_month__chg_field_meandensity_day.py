...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MeanDensity.month'
        db.alter_column('monitoring_meandensity', 'month', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True))

        # Changing field 'MeanDensity.day'
        db.alter_column('monitoring_meandensity', 'day', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'MeanDensity.month'
        db.alter_column('monitoring_meandensity', 'month', self.gf('django.db.models.fields.IntegerField')(blank=True))

        # Changing field 'MeanDensity.day'
        db.alter_column('monitoring_meandensity', 'day', self.gf('django.db.models.fields.IntegerField')(blank=True))
