...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video.full_thumbnail'
        db.add_column('monitoring_video', 'full_thumbnail', self.gf('django.db.models.fields.URLField')(max_length=200, null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Video.full_thumbnail'
        db.delete_column('monitoring_video', 'full_thumbnail')
