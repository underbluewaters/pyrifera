...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Taxon.notes'
        db.alter_column('monitoring_taxon', 'notes', self.gf('django.db.models.fields.TextField')(blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Taxon.notes'
        db.alter_column('monitoring_taxon', 'notes', self.gf('django.db.models.fields.TextField')())
