...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('monitoring_excludedsearchterms', 'monitoring_excludedsearchterm')


    def backwards(self, orm):
        db.rename_table('monitoring_excludedsearchterm','monitoring_excludedsearchterm')
