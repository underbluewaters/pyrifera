...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MeanDensity.stderror'
        db.alter_column('monitoring_meandensity', 'stderror', self.gf('django.db.models.fields.FloatField')(blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'MeanDensity.stderror'
        db.alter_column('monitoring_meandensity', 'stderror', self.gf('django.db.models.fields.FloatField')())
    ...
    models = {
        ...
        'monitoring.meandensity': {
            ...
            'stderror': ('django.db.models.fields.FloatField', [], {'blank': 'True'}),
