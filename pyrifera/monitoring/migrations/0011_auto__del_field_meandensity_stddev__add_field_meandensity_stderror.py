...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MeanDensity.stddev'
        db.delete_column('monitoring_meandensity', 'stddev')

        # Adding field 'MeanDensity.stderror'
        db.add_column('monitoring_meandensity', 'stderror', self.gf('django.db.models.fields.FloatField')(default=123), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'MeanDensity.stddev'
        db.add_column('monitoring_meandensity', 'stddev', self.gf('django.db.models.fields.FloatField')(default=123), keep_default=False)

        # Deleting field 'MeanDensity.stderror'
        db.delete_column('monitoring_meandensity', 'stderror')
