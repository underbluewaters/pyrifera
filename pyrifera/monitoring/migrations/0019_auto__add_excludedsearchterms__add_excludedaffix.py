...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ExcludedSearchTerms'
        db.create_table('monitoring_excludedsearchterms', (
            ('term', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('monitoring', ['ExcludedSearchTerms'])

        # Adding model 'ExcludedAffix'
        db.create_table('monitoring_excludedaffix', (
            ('affix', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('monitoring', ['ExcludedAffix'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'ExcludedSearchTerms'
        db.delete_table('monitoring_excludedsearchterms')

        # Deleting model 'ExcludedAffix'
        db.delete_table('monitoring_excludedaffix')
    ...
    models = {
        ...
        'monitoring.excludedsearchterms': {
            'Meta': {'object_name': 'ExcludedSearchTerms'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
