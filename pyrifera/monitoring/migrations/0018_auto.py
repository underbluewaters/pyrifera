...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Taxon', fields ['common_name']
        db.create_index('monitoring_taxon', ['common_name'])

        # Adding index on 'Taxon', fields ['genus']
        db.create_index('monitoring_taxon', ['genus'])

        # Adding index on 'MeanDensity', fields ['year']
        db.create_index('monitoring_meandensity', ['year'])

        # Adding index on 'WaterTemperature', fields ['date']
        db.create_index('monitoring_watertemperature', ['date'])
    
    
    def backwards(self, orm):
        
        # Removing index on 'Taxon', fields ['common_name']
        db.delete_index('monitoring_taxon', ['common_name'])

        # Removing index on 'Taxon', fields ['genus']
        db.delete_index('monitoring_taxon', ['genus'])

        # Removing index on 'MeanDensity', fields ['year']
        db.delete_index('monitoring_meandensity', ['year'])

        # Removing index on 'WaterTemperature', fields ['date']
        db.delete_index('monitoring_watertemperature', ['date'])
